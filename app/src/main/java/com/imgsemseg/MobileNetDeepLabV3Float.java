...
public class MobileNetDeepLabV3Float extends TFLiteImageSemanticSegmenter {
    ...
    private static final int INPUT_IMG_W = 224;
    private static final int INPUT_IMG_H = 224;
    private static final int NUM_CLASSES = 2;
    private static final int BYTES_PER_CHANNEL = 4;
    private static final int IMAGE_MEAN = 128;
    private static final float IMAGE_STD = 128.0f;
    private static final String MODEL_FILEPATH = "converted_model_224_test_quant(2).tflite";
